...
export function rollDisposition() {
  ...
  if (dispositionRoll >= 1 && dispositionRoll <= 6) {
    ...
    disposition = "Paternal, overbearing, overprotective of others (especially young ones)";
    ...
    disposition = "Complainer, constantly aggravated about something or somebody";
    ...
    disposition = "Easy going, laid back, trusts almost anyone until they are proven unworthy of trust.";
  } else if (dispositionRoll >= 96 && dispositionRoll <= 100) {
    disposition = "Paranoid, trusts no one";
  }

  document.getElementById("final-character-disposition").textContent = "Disposition: " + disposition;
}

export function rollPersonalHostilities() {
  ...
  document.getElementById("final-character-hostility").textContent = "Personal Hostility: " + hostility;
}

export function rollLandOfOrigin() {
  ...
  document.getElementById("final-character-origin").textContent = "Land of Origin: " + origin;
}